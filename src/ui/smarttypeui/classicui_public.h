...
FCITX_ADDON_DECLARE_FUNCTION(ClassicUI, flash, void(fcitx::InputContext *inputContext, const std::string &correction));
FCITX_ADDON_DECLARE_FUNCTION(ClassicUI, bounce, void(fcitx::InputContext *inputContext, bool right));
