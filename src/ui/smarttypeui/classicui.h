...
public:
    ...
    virtual void flash(InputContext * /*inputContext*/, const std::string & /*correction*/) {}
    virtual void bounce(InputContext * /*inputContext*/, bool /*right*/) {}
...
FCITX_CONFIGURATION(
    ...
    Option<std::string, NotEmpty, DefaultMarshaller<std::string>,
           ThemeAnnotation>
        theme{this, "Theme", _("Theme"), "smarttype-liquid-glass"};
    Option<std::string, NotEmpty, DefaultMarshaller<std::string>,
           ThemeAnnotation>
        themeDark{this, "DarkTheme", _("Dark Theme"),
    ...
    Option<int, IntConstrain> candidatePanelScale{
        this,
        "CandidatePanelScale",
        _("Candidate panel size (%)"),
        100,
        IntConstrain(80, 130)};);
...
public:
    ...
    void setConfig(const RawConfig &config) override {
        ...
        safeSaveAsIni(config_, "conf/smarttypeui.conf");
        reloadTheme();
    }
    ...
    void flash(InputContext *inputContext, const std::string &correction);
    void bounce(InputContext *inputContext, bool right);
...
private:
    ...
    FCITX_ADDON_EXPORT_FUNCTION(ClassicUI, flash);
    FCITX_ADDON_EXPORT_FUNCTION(ClassicUI, bounce);
