...
| Ubuntu 26.04, GNOME, Wayland | проверено в GNOME Text Editor и после холодного входа; ниже указано ограничение Firefox Snap |
...
Установщик определяет Fedora/Ubuntu/Kali, KDE/GNOME/Xfce и Wayland/X11, скачивает готовую
